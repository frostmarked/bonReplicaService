...
public class EntityChangeAspect extends AbstractEntityChangeAspect {

	public EntityChangeAspect(Javers javers, KafkaTemplate<String, EntityChangeVO> entityChangeKafkaTemplate) {
		super(javers, entityChangeKafkaTemplate);
    }
