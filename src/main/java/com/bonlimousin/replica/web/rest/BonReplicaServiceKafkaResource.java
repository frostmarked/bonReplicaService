...
@RestController
@RequestMapping("/api/bon-replica-service-kafka")
public class BonReplicaServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BonReplicaServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BonReplicaServiceKafkaResource(KafkaProperties kafkaProperties) {
